...
class AzureJobTest extends TestCase
{
    ...
    /** @test */
    public function it_can_fire_job()
    {
        $this->job = Mockery::mock(AzureJob::class, [$this->app, $this->azure, $this->message, 'myqueue'])->makePartial()->shouldAllowMockingProtectedMethods();
        $this->job->shouldReceive('resolveAndFire')->once();
